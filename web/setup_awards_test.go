...
func TestSetupAwards(t *testing.T) {
	...
	web.arena.Database.CreateAward(&model.Award{Id: 0, Type: model.JudgedAward, AwardName: "Spirit Award", TeamId: 0, PersonName: ""})
	web.arena.Database.CreateAward(&model.Award{Id: 0, Type: model.JudgedAward, AwardName: "Saftey Award", TeamId: 0, PersonName: ""})
